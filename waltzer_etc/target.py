...
from waltzer_etc import utils as u
...
class Target():
    ...
    def __init__(
        ...
        metal_star=np.nan, v_mag=np.nan, ra=np.nan, dec=np.nan,
    ...
    def machine_readable_text(self):
        ...
        v_mag = u.as_str(self.v_mag, '.2f', 'np.nan')
